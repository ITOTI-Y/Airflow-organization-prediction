...
class VNetwork:
    ...
    def jacobian(self,B,BP,H,R):
        eps = 1e-6
        diag_elements = 0.5 / (np.sqrt(R * np.abs(BP + H))+eps).flatten()
...
if __name__ == "__main__":
    node_num = 17
    edge_list = [(0, 11), (0, 1), (0, 3), (0, 14), (1, 8), (1, 3), (1, 4), (2, 3), (3, 8), (3, 10), (3, 11), (3, 13), (3, 14), (3, 16), (4, 5), (4, 6), (4, 7), (9, 11), (11, 12), (12, 14), (14, 15)]
    out_node = [0]
    pressure_dict = {(0, 11): 1.0, (0, 1): 2.0, (0, 3): 3.0, (0, 14): 4.0, (1, 8): 0, (1, 3): 0, (1, 4): 0, (2, 3): 0, (3, 8): 0, (3, 10): 0, (3, 11): 0, (3, 13): 0, (3, 14): 0, (3, 16): 0, (4, 5): 0, (4, 6): 0, (4, 7): 0, (9, 11): 0, (11, 12): 0, (12, 14): 0, (14, 15): 0}
